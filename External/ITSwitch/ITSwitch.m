...
// ---------------------------------------------------------------------------------------
#pragma mark - NSColor Addition for OS X <= 10.7 support, commented because CRASH in 10.9 in archive runs
// ---------------------------------------------------------------------------------------
...
- (void)reloadLayer {
    ...
    [CATransaction setAnimationDuration:kAnimationDuration];
    {
        ...
        // ------------------------------- Animate Frame
        if (!self.hasDragged) {
            CAMediaTimingFunction *function = [CAMediaTimingFunction functionWithControlPoints:0.25f :1.0f :0.5f :1.0f];
